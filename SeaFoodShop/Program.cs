...
{
    options.AddPolicy("MinhDz", builder =>
    {   
        builder.AllowCredentials().AllowAnyHeader().AllowAnyMethod().SetIsOriginAllowed(origin => true);
    });
});
...
builder.Services.AddScoped<ManagerAccountRespon>();
