            ...
            <tr>
                ...
                <td class="popup_trigger--user" onclick="togglePopup(event,'popup_content--user')">
                    ...
                    <div class="popup_content--user d-flex d-none flex-column">
                        <a href="#" class="popup-option" onclick="detailUser(event,${
                          user.phoneNumber
                        })">Detail</a>
                        ${
                          user.status === -2
...
function renderUserPagination(currentUserPage, totalPage, paginationLoad) {
  ...
  htmlContent += `<li class="page_item--user">
                    ...
                    <li class="page_item--user">
                        <a class="page-link" href="#" onclick="periousUserPage(${
                          lastUserPage
  ...
  htmlContent += `<li class="page_item--user">
                        <a class="page-link" href="#" onclick="nextUserPage(${
                          currentUserPage + 4
                        },${totalPage})">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-10 px-xl-10">
                                ...
                                <ul class="list-unstyled mb-1-9">
                                    <li class="mb-2 mb-xl-3 display-28"><span class="display-26 text-secondary me-2 font-weight-600">Phone number:</span> ${
                                      data.phoneNumber
                                    }</li>
                                    ...
                                    <li class="mb-2 mb-xl-3 display-28"><span class="display-26 text-secondary me-2 font-weight-600">Gender:</span>${
                                      data.gender === 0 ? "Nam" : "Nữ"
                                    }</li>
                                    <li class="mb-2 mb-xl-3 display-28"><span class="display-26 text-secondary me-2 font-weight-600">Status:</span>${
                                      data.status === 0
                                        ? "Unlock"
                                        : data.status === -1
                                        ? "Lock"
            ...
            <tr>
                ...
                <td class="popup_trigger--product" onclick="togglePopup(event,'popup_content--product')">
                    ...
                    <div class="popup_content--product d-flex d-none flex-column">
                        <a href="#" class="popup-option" onclick="detailProduct(event,${
                          product.id
                        })">Detail</a>
                        <a href="#" class="popup-option" onclick="deleteProduct(event,${
                          product.id
                        })">Delete</a>
                    </div>
                </td>
...
function renderProductPagination(
  ...
  htmlContent += `<li class="page_item--Product">
                    ...
                    <li class="page_item--Product">
                        <a class="page-link" href="#" onclick="periousProductPage(${
                          lastProductPage
  ...
  htmlContent += `<li class="page_item--product">
                        <a class="page-link" href="#" onclick="nextProductPage(${
                          currentProductPage + 4
                        },${totalPage})">
                            <i class="fa fa-angle-right"></i>
                        </a>
...
async function fetchAddBlog(token) {
  ...
  var description = tinymce.activeEditor.getContent("textPalce");
  var primaryImage =
    document.getElementById("selectedBlogImage").dataset.filename; // Lấy tên ảnh chính từ dataset
  var seafoodImages = [];
  var imageInputs = [
    "selectedImageFirstChild",
    "selectedImageSecondChild",
